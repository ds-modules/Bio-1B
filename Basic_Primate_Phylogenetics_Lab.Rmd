...
author: "Isaac Krone & Dr. Helian Ratsirarson"
date: "2026-09-07"
To Run a cell and Advance to the next one: Press Shift and Enter simultaneously
---
...
Run the code block below by pressing Shift and Enter simultaneously. This installation may take a moment, and you may see some normal code ouptut. Don't be alarmed by the pink colored cells unless you see the word ERROR on top of the output cell. Tell your instructor if an ERROR occured. Otherwise, you may move on and run the next cell while the program loads the needed software.
...
Once again, we'll use `bab` to find all the most parsimonious trees. Now we find only one parsimonious tree. 
