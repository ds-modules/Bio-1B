...
If you are using the RStudio application or the RStudio environment in Juypter notebooks, run the code block below by pressing Shift and Enter simultaneously or clicking the small triangle or play button in the upper middle window. This step will take a moment, and you'll see some normal code ouptut. Don't be alarmed by the pink colored cells.
